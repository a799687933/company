...
<div class="box">
  <div class="box-body table-responsive">
    ...
    <ob_link><a class="btn confirm ajax-get" href="<?php echo url('member/clean'); ?>"><i class="fa fa-trash-o"></i>清空所有数据库</a></ob_link>
  </div>
</div>
    </section>
    <!-- /.content -->
