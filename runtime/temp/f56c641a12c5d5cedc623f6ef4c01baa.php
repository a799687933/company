...
<div class="box">
  <div class="box-header">
        <ob_link><a href="<?php echo url('shopCategoryAdd'); ?>" class="btn"><i class="fa fa-plus"></i> 新 增</a></ob_link>
        <br/>
  </div>
            ...
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                  ...
                  <td class="col-md-2 text-center">
                      <ob_link><a href="<?php echo url('shopCategoryEdit', array('id' => $vo['id'])); ?>" class="btn"><i class="fa fa-edit"></i> 编辑</a></ob_link>
                      <ob_link><a class="btn confirm ajax-get"  href="<?php echo url('shopCategoryDel', array('id' => $vo['id'])); ?>"><i class="fa fa-trash-o"></i> 删除</a></ob_link>
                  </td>
                </tr>
