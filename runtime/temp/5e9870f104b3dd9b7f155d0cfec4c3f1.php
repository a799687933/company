    ...
    <div class="box">
        ...
        <div class="box-body no-padding">
         ...
         <!--    <tr>
          ...
          <!--   <tr>
              <td>左区</td>
              <td><?php echo $info['zone_a']; ?></a></td>
            </tr> -->
            <!-- <tr>
              <td>B区</td>
              <td><?php echo $info['zone_b']; ?></td>
            </tr> -->
           <!--  <tr>
              <td>右区</td>
              <td><?php echo $info['zone_c']; ?></td>
            </tr> -->
          <!--  <tr>
              <td>奖金币钱包</td>
              <td><?php echo $info['b0']; ?></td>
            </tr> -->

           <!--   <tr>
              <td>积分钱包</td>
              <td><?php echo $info['b1']; ?></td>
            </tr> -->
          </tbody>
          </table>
        </div>
