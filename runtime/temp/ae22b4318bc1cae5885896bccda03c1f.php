        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label>名称</label>
              <span>（产品分类名称）</span>
              <input class="form-control" name="name" placeholder="请输入产品分类名称" value="<?php echo (isset($info['name']) && ($info['name'] !== '')?$info['name']:''); ?>" type="text">
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
                <label>描述</label>
                <span>（产品分类描述）</span>
                <textarea class="form-control" name="describe" rows="3" placeholder="请输入产品分类描述"><?php echo (isset($info['describe']) && ($info['describe'] !== '')?$info['describe']:''); ?></textarea>
            </div>
          </div>
          </div>
        </div>
