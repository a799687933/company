...
<div class="box">
  ...
  <!--   <ob_link><a id="data_backup" class="btn" url="<?php echo url('dataBackup'); ?>"><i class="fa fa-download"></i> 下载数据</a></ob_link> -->
